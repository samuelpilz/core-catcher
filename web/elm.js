...
var _user$project$Protocol$jsonEncGameError = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'myError',
				_1: _elm_lang$core$Json_Encode$string(val.myError)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Protocol$jsonDecGameError = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'myError', _elm_lang$core$Json_Decode$string),
	function (pmyError) {
		return _elm_lang$core$Json_Decode$succeed(
			{myError: pmyError});
	});
var _user$project$Protocol$jsonEncTransport = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'transportName',
				_1: _elm_lang$core$Json_Encode$string(val.transportName)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Protocol$jsonDecTransport = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'transportName', _elm_lang$core$Json_Decode$string),
	function (ptransportName) {
		return _elm_lang$core$Json_Decode$succeed(
			{transportName: ptransportName});
	});
var _user$project$Protocol$jsonEncNode = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'nodeId',
				_1: _elm_lang$core$Json_Encode$int(val.nodeId)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Protocol$jsonEncRogueHistory = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
						...
						A2(
							...
							function (_p1) {
								...
								return _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _user$project$Protocol$jsonEncTransport(_p2._0),
										_1: {
											ctor: '::',
											_0: A2(_bartavelle$json_helpers$Json_Helpers$maybeEncode, _user$project$Protocol$jsonEncNode, _p2._1),
											_1: {ctor: '[]'}
										}
									});
							},
...
var _user$project$Protocol$jsonDecNode = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'nodeId', _elm_lang$core$Json_Decode$int),
	function (pnodeId) {
		return _elm_lang$core$Json_Decode$succeed(
			{nodeId: pnodeId});
	});
var _user$project$Protocol$jsonDecRogueHistory = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(
		_bartavelle$json_helpers$Json_Helpers_ops[':='],
		'rogueHistory',
		_elm_lang$core$Json_Decode$list(
			A3(
				...
				A2(_elm_lang$core$Json_Decode$index, 0, _user$project$Protocol$jsonDecTransport),
				A2(
					_elm_lang$core$Json_Decode$index,
					1,
					_elm_lang$core$Json_Decode$maybe(_user$project$Protocol$jsonDecNode))))),
	function (progueHistory) {
		return _elm_lang$core$Json_Decode$succeed(
			{rogueHistory: progueHistory});
	});
var _user$project$Protocol$jsonEncEdge = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: function (_p3) {
					...
					return _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _user$project$Protocol$jsonEncNode(_p4._0),
							_1: {
								ctor: '::',
								_0: _user$project$Protocol$jsonEncNode(_p4._1),
								_1: {ctor: '[]'}
							}
						});
				}(val.edge)
...
var _user$project$Protocol$jsonDecEdge = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(
		_bartavelle$json_helpers$Json_Helpers_ops[':='],
		'edge',
		A3(
			...
			A2(_elm_lang$core$Json_Decode$index, 0, _user$project$Protocol$jsonDecNode),
			A2(_elm_lang$core$Json_Decode$index, 1, _user$project$Protocol$jsonDecNode))),
	function (pedge) {
		return _elm_lang$core$Json_Decode$succeed(
			{edge: pedge});
	});
var _user$project$Protocol$jsonEncPlayer = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'playerId',
				_1: _elm_lang$core$Json_Encode$int(val.playerId)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Protocol$jsonDecPlayer = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'playerId', _elm_lang$core$Json_Decode$int),
	function (pplayerId) {
		return _elm_lang$core$Json_Decode$succeed(
			{playerId: pplayerId});
	});
var _user$project$Protocol$jsonEncNetworkOverlay = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: function (_p5) {
					return _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Protocol$jsonEncNode, _p5));
				}(val.overlayNodes)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: function (_p6) {
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Protocol$jsonEncEdge, _p6));
					}(val.overlayEdges)
				},
				_1: {ctor: '[]'}
			}
...
var _user$project$Protocol$jsonDecNetworkOverlay = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(
		_bartavelle$json_helpers$Json_Helpers_ops[':='],
		'overlayNodes',
		_elm_lang$core$Json_Decode$list(_user$project$Protocol$jsonDecNode)),
	function (poverlayNodes) {
		return A2(
			_bartavelle$json_helpers$Json_Helpers_ops['>>='],
			A2(
				_bartavelle$json_helpers$Json_Helpers_ops[':='],
				'overlayEdges',
				_elm_lang$core$Json_Decode$list(_user$project$Protocol$jsonDecEdge)),
			function (poverlayEdges) {
				return _elm_lang$core$Json_Decode$succeed(
					{overlayNodes: poverlayNodes, overlayEdges: poverlayEdges});
			});
	});
var _user$project$Protocol$jsonEncNetwork = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: function (_p7) {
					return _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Protocol$jsonEncNode, _p7));
				}(val.nodes)
			},
			_1: {
				ctor: '::',
							...
							A2(
								...
								function (_p9) {
									...
									return _elm_lang$core$Json_Encode$list(
										{
											ctor: '::',
											_0: _user$project$Protocol$jsonEncTransport(_p10._0),
											_1: {
												ctor: '::',
												_0: _user$project$Protocol$jsonEncNetworkOverlay(_p10._1),
												_1: {ctor: '[]'}
											}
										});
								},
...
var _user$project$Protocol$jsonDecNetwork = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(
		_bartavelle$json_helpers$Json_Helpers_ops[':='],
		'nodes',
			...
			A2(
				...
				_elm_lang$core$Json_Decode$list(
					A3(
						...
						A2(_elm_lang$core$Json_Decode$index, 0, _user$project$Protocol$jsonDecTransport),
						A2(_elm_lang$core$Json_Decode$index, 1, _user$project$Protocol$jsonDecNetworkOverlay)))),
			function (poverlays) {
				return _elm_lang$core$Json_Decode$succeed(
					{nodes: pnodes, overlays: poverlays});
			});
	});
var _user$project$Protocol$jsonEncEnergyMap = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
						...
						A2(
							...
							function (_p12) {
								...
								return _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _user$project$Protocol$jsonEncTransport(_p13._0),
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$int(_p13._1),
											_1: {ctor: '[]'}
										}
									});
							},
...
var _user$project$Protocol$jsonDecEnergyMap = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(
		_bartavelle$json_helpers$Json_Helpers_ops[':='],
		'energyMap',
	...
	function (penergyMap) {
		return _elm_lang$core$Json_Decode$succeed(
			{energyMap: penergyMap});
	});
var _user$project$Protocol$jsonEncPlayerEnergies = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
						...
						A2(
							...
							function (_p15) {
								...
								return _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _user$project$Protocol$jsonEncPlayer(_p16._0),
										_1: {
											ctor: '::',
											_0: _user$project$Protocol$jsonEncEnergyMap(_p16._1),
											_1: {ctor: '[]'}
										}
									});
							},
...
var _user$project$Protocol$jsonDecPlayerEnergies = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(
		_bartavelle$json_helpers$Json_Helpers_ops[':='],
		'playerEnergies',
		_elm_lang$core$Json_Decode$list(
			A3(
				...
				A2(_elm_lang$core$Json_Decode$index, 0, _user$project$Protocol$jsonDecPlayer),
				A2(_elm_lang$core$Json_Decode$index, 1, _user$project$Protocol$jsonDecEnergyMap)))),
	function (pplayerEnergies) {
		return _elm_lang$core$Json_Decode$succeed(
			{playerEnergies: pplayerEnergies});
	});
var _user$project$Protocol$jsonEncPlayerPositions = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
						...
						A2(
							...
							function (_p18) {
								...
								return _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _user$project$Protocol$jsonEncPlayer(_p19._0),
										_1: {
											ctor: '::',
											_0: _user$project$Protocol$jsonEncNode(_p19._1),
											_1: {ctor: '[]'}
										}
									});
							},
...
var _user$project$Protocol$jsonEncRogueGameView = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'roguePlayerPositions',
				_1: _user$project$Protocol$jsonEncPlayerPositions(val.roguePlayerPositions)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'rogueEnergies',
					_1: _user$project$Protocol$jsonEncPlayerEnergies(val.rogueEnergies)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'rogueOwnHistory',
						_1: _user$project$Protocol$jsonEncRogueHistory(val.rogueOwnHistory)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'rogueNextPlayer',
							_1: _user$project$Protocol$jsonEncPlayer(val.rogueNextPlayer)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Protocol$jsonEncCatcherGameView = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'catcherPlayerPositions',
				_1: _user$project$Protocol$jsonEncPlayerPositions(val.catcherPlayerPositions)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'catcherEnergies',
					_1: _user$project$Protocol$jsonEncPlayerEnergies(val.catcherEnergies)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'catcherRogueHistory',
						_1: _user$project$Protocol$jsonEncRogueHistory(val.catcherRogueHistory)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'catcherNextPlayer',
							_1: _user$project$Protocol$jsonEncPlayer(val.catcherNextPlayer)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Protocol$jsonEncGameView = function (val) {
	var keyval = function (v) {
		var _p20 = v;
		if (_p20.ctor === 'RogueView') {
			return {
				ctor: '_Tuple2',
				_0: 'RogueView',
				_1: _bartavelle$json_helpers$Json_Helpers$encodeValue(
					_user$project$Protocol$jsonEncRogueGameView(_p20._0))
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: 'CatcherView',
				_1: _bartavelle$json_helpers$Json_Helpers$encodeValue(
					_user$project$Protocol$jsonEncCatcherGameView(_p20._0))
			};
		}
	};
	return A2(_bartavelle$json_helpers$Json_Helpers$encodeSumObjectWithSingleField, keyval, val);
};
var _user$project$Protocol$jsonEncInitialInfoForClient = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'initialPlayer',
				_1: _user$project$Protocol$jsonEncPlayer(val.initialPlayer)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'networkForGame',
					_1: _user$project$Protocol$jsonEncNetwork(val.networkForGame)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'initialGameView',
						_1: _user$project$Protocol$jsonEncGameView(val.initialGameView)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Protocol$jsonEncMessageForClient = function (val) {
	var keyval = function (v) {
		var _p21 = v;
		if (_p21.ctor === 'GameView_') {
			return {
				ctor: '_Tuple2',
				_0: 'GameView_',
				_1: _bartavelle$json_helpers$Json_Helpers$encodeValue(
					_user$project$Protocol$jsonEncGameView(_p21._0))
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: 'InitialInfoForClient_',
				_1: _bartavelle$json_helpers$Json_Helpers$encodeValue(
					_user$project$Protocol$jsonEncInitialInfoForClient(_p21._0))
			};
		}
	};
	return A2(_bartavelle$json_helpers$Json_Helpers$encodeSumObjectWithSingleField, keyval, val);
};
var _user$project$Protocol$jsonDecPlayerPositions = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(
		_bartavelle$json_helpers$Json_Helpers_ops[':='],
		'playerPositions',
		_elm_lang$core$Json_Decode$list(
			A3(
				...
				A2(_elm_lang$core$Json_Decode$index, 0, _user$project$Protocol$jsonDecPlayer),
				A2(_elm_lang$core$Json_Decode$index, 1, _user$project$Protocol$jsonDecNode)))),
	function (pplayerPositions) {
		return _elm_lang$core$Json_Decode$succeed(
			{playerPositions: pplayerPositions});
	});
var _user$project$Protocol$jsonDecRogueGameView = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'roguePlayerPositions', _user$project$Protocol$jsonDecPlayerPositions),
	function (proguePlayerPositions) {
		return A2(
			_bartavelle$json_helpers$Json_Helpers_ops['>>='],
			A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'rogueEnergies', _user$project$Protocol$jsonDecPlayerEnergies),
			function (progueEnergies) {
				return A2(
					_bartavelle$json_helpers$Json_Helpers_ops['>>='],
					A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'rogueOwnHistory', _user$project$Protocol$jsonDecRogueHistory),
					function (progueOwnHistory) {
						return A2(
							_bartavelle$json_helpers$Json_Helpers_ops['>>='],
							A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'rogueNextPlayer', _user$project$Protocol$jsonDecPlayer),
							function (progueNextPlayer) {
								return _elm_lang$core$Json_Decode$succeed(
									{roguePlayerPositions: proguePlayerPositions, rogueEnergies: progueEnergies, rogueOwnHistory: progueOwnHistory, rogueNextPlayer: progueNextPlayer});
							});
					});
			});
	});
var _user$project$Protocol$jsonDecCatcherGameView = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'catcherPlayerPositions', _user$project$Protocol$jsonDecPlayerPositions),
	function (pcatcherPlayerPositions) {
		return A2(
			_bartavelle$json_helpers$Json_Helpers_ops['>>='],
			A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'catcherEnergies', _user$project$Protocol$jsonDecPlayerEnergies),
			function (pcatcherEnergies) {
				return A2(
					_bartavelle$json_helpers$Json_Helpers_ops['>>='],
					A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'catcherRogueHistory', _user$project$Protocol$jsonDecRogueHistory),
					function (pcatcherRogueHistory) {
						return A2(
							_bartavelle$json_helpers$Json_Helpers_ops['>>='],
							A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'catcherNextPlayer', _user$project$Protocol$jsonDecPlayer),
							function (pcatcherNextPlayer) {
								return _elm_lang$core$Json_Decode$succeed(
									{catcherPlayerPositions: pcatcherPlayerPositions, catcherEnergies: pcatcherEnergies, catcherRogueHistory: pcatcherRogueHistory, catcherNextPlayer: pcatcherNextPlayer});
							});
					});
			});
	});
var _user$project$Protocol$jsonEncAction = function (val) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'actionPlayer',
				_1: _user$project$Protocol$jsonEncPlayer(val.actionPlayer)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'actionTransport',
					_1: _user$project$Protocol$jsonEncTransport(val.actionTransport)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'actionNode',
						_1: _user$project$Protocol$jsonEncNode(val.actionNode)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Protocol$jsonEncMessageForServer = function (_p22) {
	var _p23 = _p22;
	return _user$project$Protocol$jsonEncAction(_p23._0);
};
var _user$project$Protocol$jsonDecAction = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'actionPlayer', _user$project$Protocol$jsonDecPlayer),
	function (pactionPlayer) {
		return A2(
			_bartavelle$json_helpers$Json_Helpers_ops['>>='],
			A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'actionTransport', _user$project$Protocol$jsonDecTransport),
			function (pactionTransport) {
				return A2(
					_bartavelle$json_helpers$Json_Helpers_ops['>>='],
					A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'actionNode', _user$project$Protocol$jsonDecNode),
					function (pactionNode) {
						return _elm_lang$core$Json_Decode$succeed(
							{actionPlayer: pactionPlayer, actionTransport: pactionTransport, actionNode: pactionNode});
					});
			});
	});
var _user$project$Protocol$Action = F3(
	function (a, b, c) {
		return {actionPlayer: a, actionTransport: b, actionNode: c};
	});
var _user$project$Protocol$PlayerPositions = function (a) {
	return {playerPositions: a};
};
var _user$project$Protocol$RogueGameView = F4(
	function (a, b, c, d) {
		return {roguePlayerPositions: a, rogueEnergies: b, rogueOwnHistory: c, rogueNextPlayer: d};
	});
var _user$project$Protocol$CatcherGameView = F4(
	function (a, b, c, d) {
		return {catcherPlayerPositions: a, catcherEnergies: b, catcherRogueHistory: c, catcherNextPlayer: d};
	});
var _user$project$Protocol$PlayerEnergies = function (a) {
	return {playerEnergies: a};
};
var _user$project$Protocol$EnergyMap = function (a) {
	return {energyMap: a};
};
var _user$project$Protocol$Network = F2(
	function (a, b) {
		return {nodes: a, overlays: b};
	});
var _user$project$Protocol$NetworkOverlay = F2(
	function (a, b) {
		return {overlayNodes: a, overlayEdges: b};
	});
var _user$project$Protocol$Player = function (a) {
	return {playerId: a};
};
var _user$project$Protocol$Edge = function (a) {
	return {edge: a};
};
var _user$project$Protocol$Node = function (a) {
	return {nodeId: a};
};
var _user$project$Protocol$Transport = function (a) {
	return {transportName: a};
};
var _user$project$Protocol$RogueHistory = function (a) {
	return {rogueHistory: a};
};
var _user$project$Protocol$GameError = function (a) {
	return {myError: a};
};
var _user$project$Protocol$InitialInfoForClient = F3(
	function (a, b, c) {
		return {initialPlayer: a, networkForGame: b, initialGameView: c};
	});
var _user$project$Protocol$CatcherView = function (a) {
	return {ctor: 'CatcherView', _0: a};
};
var _user$project$Protocol$RogueView = function (a) {
	return {ctor: 'RogueView', _0: a};
};
var _user$project$Protocol$jsonDecGameView = function () {
	var jsonDecDictGameView = _elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'RogueView',
				_1: A2(_elm_lang$core$Json_Decode$map, _user$project$Protocol$RogueView, _user$project$Protocol$jsonDecRogueGameView)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'CatcherView',
					_1: A2(_elm_lang$core$Json_Decode$map, _user$project$Protocol$CatcherView, _user$project$Protocol$jsonDecCatcherGameView)
				},
				_1: {ctor: '[]'}
			}
		});
	return A2(_bartavelle$json_helpers$Json_Helpers$decodeSumObjectWithSingleField, 'GameView', jsonDecDictGameView);
}();
var _user$project$Protocol$jsonDecInitialInfoForClient = A2(
	_bartavelle$json_helpers$Json_Helpers_ops['>>='],
	A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'initialPlayer', _user$project$Protocol$jsonDecPlayer),
	function (pinitialPlayer) {
		return A2(
			_bartavelle$json_helpers$Json_Helpers_ops['>>='],
			A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'networkForGame', _user$project$Protocol$jsonDecNetwork),
			function (pnetworkForGame) {
				return A2(
					_bartavelle$json_helpers$Json_Helpers_ops['>>='],
					A2(_bartavelle$json_helpers$Json_Helpers_ops[':='], 'initialGameView', _user$project$Protocol$jsonDecGameView),
					function (pinitialGameView) {
						return _elm_lang$core$Json_Decode$succeed(
							{initialPlayer: pinitialPlayer, networkForGame: pnetworkForGame, initialGameView: pinitialGameView});
					});
			});
	});
var _user$project$Protocol$Action_ = function (a) {
	return {ctor: 'Action_', _0: a};
};
var _user$project$Protocol$jsonDecMessageForServer = A2(_elm_lang$core$Json_Decode$map, _user$project$Protocol$Action_, _user$project$Protocol$jsonDecAction);
var _user$project$Protocol$InitialInfoForClient_ = function (a) {
	return {ctor: 'InitialInfoForClient_', _0: a};
};
var _user$project$Protocol$GameView_ = function (a) {
	return {ctor: 'GameView_', _0: a};
};
var _user$project$Protocol$jsonDecMessageForClient = function () {
	var jsonDecDictMessageForClient = _elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'GameView_',
				_1: A2(_elm_lang$core$Json_Decode$map, _user$project$Protocol$GameView_, _user$project$Protocol$jsonDecGameView)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'InitialInfoForClient_',
					_1: A2(_elm_lang$core$Json_Decode$map, _user$project$Protocol$InitialInfoForClient_, _user$project$Protocol$jsonDecInitialInfoForClient)
				},
				_1: {ctor: '[]'}
			}
		});
	return A2(_bartavelle$json_helpers$Json_Helpers$decodeSumObjectWithSingleField, 'MessageForClient', jsonDecDictMessageForClient);
}();

var _user$project$ProtocolUtils$emptyRogueView = {
	roguePlayerPositions: {
		playerPositions: {ctor: '[]'}
	},
	rogueEnergies: {
		playerEnergies: {ctor: '[]'}
	},
...
var _user$project$ProtocolUtils$emptyNetwork = {
	nodes: {ctor: '[]'},
	overlays: {ctor: '[]'}
};
var _user$project$ProtocolUtils$getFromList = F2(
	function (k, list) {
		return function (_p0) {
...
var _user$project$ProtocolUtils$nextPlayer = function (gameView) {
	var _p2 = gameView;
	if (_p2.ctor === 'RogueView') {
		return _p2._0.rogueNextPlayer;
	} else {
		return _p2._0.catcherNextPlayer;
	}
};
var _user$project$ProtocolUtils$rogueHistory = function (gameView) {
	var _p3 = gameView;
	if (_p3.ctor === 'RogueView') {
		return _p3._0.rogueOwnHistory;
	} else {
		return _p3._0.catcherRogueHistory;
	}
};
var _user$project$ProtocolUtils$energies = function (gameView) {
	var _p4 = gameView;
	if (_p4.ctor === 'RogueView') {
		return _p4._0.rogueEnergies;
	} else {
		return _p4._0.catcherEnergies;
	}
};
var _user$project$ProtocolUtils$getEnergyForTransportAndPlayer = F3(
	function (player, transport, gameView) {
		return function (_p5) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				0,
				A2(
					...
					_user$project$ProtocolUtils$getFromList(transport),
					A2(
						_elm_lang$core$Maybe$map,
						function (_) {
							return _.energyMap;
						},
						A2(_user$project$ProtocolUtils$getFromList, player, _p5))));
		}(
			_user$project$ProtocolUtils$energies(gameView).playerEnergies);
	});
var _user$project$ProtocolUtils$playerPositions = function (gameView) {
	var _p6 = gameView;
	if (_p6.ctor === 'RogueView') {
		return _p6._0.roguePlayerPositions;
	} else {
		return _p6._0.catcherPlayerPositions;
	}
};

var _user$project$ClientState$ClientState = F5(
	function (a, b, c, d, e) {
		return {gameView: a, network: b, player: c, selectedEnergy: d, server: e};
	});
var _user$project$ClientState$Flags = function (a) {
	return {server: a};
};
var _user$project$ClientState$None = {ctor: 'None'};
var _user$project$ClientState$MsgFromServer = function (a) {
	return {ctor: 'MsgFromServer', _0: a};
};
var _user$project$ClientState$SelectEnergy = function (a) {
	return {ctor: 'SelectEnergy', _0: a};
};
var _user$project$ClientState$Clicked = function (a) {
	return {ctor: 'Clicked', _0: a};
};

var _user$project$GameViewDisplay$indexOf = F2(
	function (a, l) {
		var _p0 = l;
		if (_p0.ctor === '[]') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Native_Utils.eq(a, _p0._0) ? _elm_lang$core$Maybe$Just(0) : A2(
				_elm_lang$core$Maybe$map,
				F2(
					function (x, y) {
						return x + y;
					})(1),
				A2(_user$project$GameViewDisplay$indexOf, a, _p0._1));
		}
	});
var _user$project$GameViewDisplay$getPriority = F2(
	function (_p1, t) {
		var _p2 = _p1;
		return function (_p3) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				-1,
				A2(_user$project$GameViewDisplay$indexOf, t, _p3));
		}(_p2.transportPriorityList);
	});
var _user$project$GameViewDisplay$nodeY = F2(
	function (nodeXyMap, n) {
		return 50 + (100 * function (_p4) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				0,
				A2(
					_elm_lang$core$Maybe$map,
					_elm_lang$core$Tuple$second,
					A2(_eeue56$elm_all_dict$AllDict$get, n, _p4)));
		}(nodeXyMap));
	});
var _user$project$GameViewDisplay$nodeX = F2(
	function (nodeXyMap, n) {
		return 50 + (100 * function (_p5) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				0,
				A2(
					_elm_lang$core$Maybe$map,
					_elm_lang$core$Tuple$first,
					A2(_eeue56$elm_all_dict$AllDict$get, n, _p5)));
		}(nodeXyMap));
	});
var _user$project$GameViewDisplay$displayInfoForTransport = F2(
	function (_p6, transport) {
		var _p7 = _p6;
		return A5(
			_elm_lang$core$Maybe$map4,
			F4(
				function (c, e, n, xy) {
					return {color: c, edgeWidth: e, nodeSize: n, nodeXyMap: xy};
				}),
			A2(_eeue56$elm_all_dict$AllDict$get, transport, _p7.colorMap),
			A2(_eeue56$elm_all_dict$AllDict$get, transport, _p7.edgeWidthMap),
			A2(_eeue56$elm_all_dict$AllDict$get, transport, _p7.nodeSizeMap),
			_elm_lang$core$Maybe$Just(_p7.nodeXyMap));
	});
var _user$project$GameViewDisplay$GameViewDisplayInfo = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {colorMap: a, edgeWidthMap: b, nodeSizeMap: c, nodeXyMap: d, transportPriorityList: e, playerColorMap: f, mapWidth: g, mapHeight: h, gridWidth: i, gridHeight: j};
									};
								};
							};
						};
...
var _user$project$GameViewDisplay$OverlayDisplayInfo = F4(
	function (a, b, c, d) {
		return {color: a, edgeWidth: b, nodeSize: c, nodeXyMap: d};
	});

var _user$project$Example_ExampleGameViewDisplay$playerColorMap = A2(
...
var _user$project$Example_ExampleGameViewDisplay$nodeXyMap = A2(
	_eeue56$elm_all_dict$AllDict$fromList,
	function (_) {
		return _.nodeId;
	},
...
var _user$project$Example_ExampleGameViewDisplay$nodeSizeMap = A2(
	_eeue56$elm_all_dict$AllDict$fromList,
	function (_) {
		return _.transportName;
	},
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: {transportName: 'red'},
			_1: 28
		},
		_1: {
			ctor: '::',
...
var _user$project$Example_ExampleGameViewDisplay$edgeWidthMap = A2(
	_eeue56$elm_all_dict$AllDict$fromList,
	function (_) {
		return _.transportName;
	},
...
var _user$project$Example_ExampleGameViewDisplay$colorMap = A2(
	_eeue56$elm_all_dict$AllDict$fromList,
	function (_) {
		return _.transportName;
	},
...
var _user$project$Example_ExampleGameViewDisplay$displayInfo = {
	colorMap: _user$project$Example_ExampleGameViewDisplay$colorMap,
	edgeWidthMap: _user$project$Example_ExampleGameViewDisplay$edgeWidthMap,
	nodeSizeMap: _user$project$Example_ExampleGameViewDisplay$nodeSizeMap,
	nodeXyMap: _user$project$Example_ExampleGameViewDisplay$nodeXyMap,
	...
	playerColorMap: _user$project$Example_ExampleGameViewDisplay$playerColorMap,
	mapWidth: 800,
	mapHeight: 600,
	gridWidth: 7,
	gridHeight: 5
...
var _user$project$View_MapView$edgeLine = F4(
	function (nodeXyMap, color, edgeWidth, _p0) {
		var _p1 = _p0;
		var _p2 = _p1.edge;
		var n1 = _p2._0;
		var n2 = _p2._1;
				...
				_0: function (_p3) {
					return _elm_lang$svg$Svg_Attributes$x1(
						_elm_lang$core$Basics$toString(
							A2(_user$project$GameViewDisplay$nodeX, nodeXyMap, _p3)));
				}(n1),
				_1: {
					ctor: '::',
					_0: function (_p4) {
						return _elm_lang$svg$Svg_Attributes$y1(
							_elm_lang$core$Basics$toString(
								A2(_user$project$GameViewDisplay$nodeY, nodeXyMap, _p4)));
					}(n1),
					_1: {
						ctor: '::',
						_0: function (_p5) {
							return _elm_lang$svg$Svg_Attributes$x2(
								_elm_lang$core$Basics$toString(
									A2(_user$project$GameViewDisplay$nodeX, nodeXyMap, _p5)));
						}(n2),
						_1: {
							ctor: '::',
							_0: function (_p6) {
								return _elm_lang$svg$Svg_Attributes$y2(
									_elm_lang$core$Basics$toString(
										A2(_user$project$GameViewDisplay$nodeY, nodeXyMap, _p6)));
							}(n2),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$strokeWidth(
									_elm_lang$core$Basics$toString(edgeWidth)),
								_1: {
									ctor: '::',
...
var _user$project$View_MapView$playerCircle = F3(
	function (nodeXyMap, playerColorMap, _p7) {
		var _p8 = _p7;
		var _p12 = _p8._1;
		return A2(
			_elm_lang$svg$Svg$circle,
			{
				...
				_0: function (_p9) {
					return _elm_lang$svg$Svg_Attributes$cx(
						_elm_lang$core$Basics$toString(
							A2(_user$project$GameViewDisplay$nodeX, nodeXyMap, _p9)));
				}(_p12),
				_1: {
					ctor: '::',
					_0: function (_p10) {
						return _elm_lang$svg$Svg_Attributes$cy(
							_elm_lang$core$Basics$toString(
								A2(_user$project$GameViewDisplay$nodeY, nodeXyMap, _p10)));
					}(_p12),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function (_p11) {
									return _elm_lang$svg$Svg_Attributes$stroke(
										A2(
											_elm_lang$core$Maybe$withDefault,
											'white',
											A2(_eeue56$elm_all_dict$AllDict$get, _p8._0, _p11)));
								}(playerColorMap),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$ClientState$Clicked(_p12)),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$strokeWidth('4'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$strokeDasharray('5,3.5'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$View_MapView$nodeCircle = F2(
	function (nodeXyMap, node) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$svg$Svg$circle,
					{
						...
						_0: function (_p13) {
							return _elm_lang$svg$Svg_Attributes$cx(
								_elm_lang$core$Basics$toString(
									A2(_user$project$GameViewDisplay$nodeX, nodeXyMap, _p13)));
						}(node),
						_1: {
							ctor: '::',
							_0: function (_p14) {
								return _elm_lang$svg$Svg_Attributes$cy(
									_elm_lang$core$Basics$toString(
										A2(_user$project$GameViewDisplay$nodeY, nodeXyMap, _p14)));
							}(node),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill('#111111'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$cursor('pointer'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$ClientState$Clicked(node)),
											_1: {ctor: '[]'}
										}
									}
								}
					...
					_0: A2(
						_elm_lang$svg$Svg$text_,
						{
							...
							_0: function (_p15) {
								...
								A2(_user$project$GameViewDisplay$nodeX, nodeXyMap, node)),
							_1: {
								ctor: '::',
								_0: function (_p16) {
									...
									5 + A2(_user$project$GameViewDisplay$nodeY, nodeXyMap, node)),
								_1: {
									ctor: '::',
...
var _user$project$View_MapView$nodeCircleStop = F4(
	function (nodeXyMap, color, size, node) {
		return A2(
			_elm_lang$svg$Svg$circle,
			{
				ctor: '::',
				...
				_1: {
					...
					_0: function (_p19) {
						...
						A2(_user$project$GameViewDisplay$nodeY, nodeXyMap, node)),
					_1: {
						ctor: '::',
...
var _user$project$View_MapView$mapViewOfNetworkOverlay = F2(
	function (_p21, _p20) {
		var _p22 = _p21;
		var _p25 = _p22.nodeXyMap;
		var _p24 = _p22.color;
		var _p23 = _p20;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$List$map,
				A3(_user$project$View_MapView$edgeLine, _p25, _p24, _p22.edgeWidth),
				_p23.overlayEdges),
			A2(
				_elm_lang$core$List$map,
				A3(_user$project$View_MapView$nodeCircleStop, _p25, _p24, _p22.nodeSize),
				_p23.overlayNodes));
	});
var _user$project$View_MapView$mapViewOfNetworkOverlayName = F3(
	function (displayInfo, _p27, _p26) {
		var _p28 = _p27;
		var _p29 = _p26;
		return function (_p30) {
			return A2(
				...
				A3(
					...
					_user$project$View_MapView$mapViewOfNetworkOverlay,
					A2(_user$project$GameViewDisplay$displayInfoForTransport, displayInfo, _p29._0),
					_p30));
		}(
			_elm_lang$core$Maybe$Just(_p29._1));
	});
var _user$project$View_MapView$mapView = F3(
	function (network, displayInfo, clientState) {
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				...
				}(displayInfo.mapHeight),
				_1: {
					ctor: '::',
					_0: function (_p32) {
						return _elm_lang$svg$Svg_Attributes$width(
							_elm_lang$core$Basics$toString(_p32));
					}(displayInfo.mapWidth),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: '#cccccc'},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(_user$project$View_MapView$mapViewOfNetworkOverlayName, displayInfo, network),
						A2(
							_elm_lang$core$List$sortBy,
							function (_p33) {
								var _p34 = _p33;
								return A2(_user$project$GameViewDisplay$getPriority, displayInfo, _p34._0);
							},
							network.overlays)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(
							_elm_lang$core$List$map,
							_user$project$View_MapView$nodeCircle(displayInfo.nodeXyMap),
							network.nodes),
						A2(
							_elm_lang$core$List$map,
							A2(_user$project$View_MapView$playerCircle, displayInfo.nodeXyMap, displayInfo.playerColorMap),
							_user$project$ProtocolUtils$playerPositions(clientState.gameView).playerPositions)))));
	});

var _user$project$View_TransportView$historyRecord = F2(
	function (pos, color) {
		return A2(
			_elm_lang$svg$Svg$rect,
			{
				...
				_0: function (_p0) {
					...
					50 + (50 * A2(_elm_lang$core$Basics_ops['%'], pos, 5))),
				_1: {
					ctor: '::',
					_0: function (_p1) {
						return _elm_lang$svg$Svg_Attributes$y(
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height('49'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$cursor('pointer'),
								_1: {
...
var _user$project$View_TransportView$energyRecord = F2(
	function (selectedEnergy, _p2) {
		var _p3 = _p2;
		var _p11 = _p3._1;
		var _p10 = _p3._0;
		return A2(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$fill(_p3._2),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$stroke('#000000'),
												_1: {
													...
													_0: function (_p6) {
														...
														_elm_lang$core$Native_Utils.eq(selectedEnergy, _p11) ? 3 : 1),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$ClientState$SelectEnergy(_p11)),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _user$project$View_TransportView$historyView = F2(
	function (gameView, displayInfo) {
		return function (_p12) {
			return A3(
				_elm_lang$core$List$map2,
				_user$project$View_TransportView$historyRecord,
				A2(_elm_lang$core$List$range, 0, 100),
				A2(
					_elm_lang$core$List$map,
					_elm_lang$core$Maybe$withDefault('black'),
					A2(
						_elm_lang$core$List$map,
						function (_p13) {
							var _p14 = _p13;
							return A2(_eeue56$elm_all_dict$AllDict$get, _p14._0, displayInfo.colorMap);
						},
						_p12)));
		}(
			_user$project$ProtocolUtils$rogueHistory(gameView).rogueHistory);
	});
var _user$project$View_TransportView$energyView = F4(
	function (gameView, displayInfo, player, selectedEnergy) {
		return function (_p15) {
			return A2(
				_elm_lang$core$List$map,
				_user$project$View_TransportView$energyRecord(selectedEnergy),
				A2(
					_elm_lang$core$List$sortBy,
					function (_p16) {
						var _p17 = _p16;
					...
					A2(
						...
						function (_p18) {
							...
							return {
								ctor: '_Tuple4',
								_0: A2(_user$project$GameViewDisplay$getPriority, displayInfo, _p20),
								_1: _p20,
								_2: _p19._1,
								_3: A3(_user$project$ProtocolUtils$getEnergyForTransportAndPlayer, player, _p20, gameView)
							};
						},
						_eeue56$elm_all_dict$AllDict$toList(_p15))));
		}(displayInfo.colorMap);
	});
var _user$project$View_TransportView$transportView = F3(
	function (_p21, displayInfo, clientState) {
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(displayInfo.mapHeight)),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border-size', _1: '1'},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A4(
					_user$project$View_TransportView$energyView,
					clientState.gameView,
					displayInfo,
					{playerId: 0},
					clientState.selectedEnergy),
				A2(_user$project$View_TransportView$historyView, clientState.gameView, displayInfo)));
	});

var _user$project$Main$cons = F2(
	function (a, b) {
		return a;
	});
var _user$project$Main$log2 = F3(
	function (s, a, b) {
		return A2(
			_user$project$Main$cons,
			b,
			A2(_elm_lang$core$Debug$log, s, a));
	});
var _user$project$Main$jsonActionOfNode = F2(
	function (state, n) {
		return function (_p0) {
			return A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_user$project$Protocol$jsonEncAction(_p0));
		}(
			{actionPlayer: state.player, actionTransport: state.selectedEnergy, actionNode: n});
	});
var _user$project$Main$displayInfo = _user$project$Example_ExampleGameViewDisplay$displayInfo;
var _user$project$Main$initialState = function (flags) {
	return {
		gameView: _user$project$Protocol$RogueView(_user$project$ProtocolUtils$emptyRogueView),
		network: _user$project$ProtocolUtils$emptyNetwork,
		player: {playerId: 0},
		selectedEnergy: {transportName: 'orange'},
		server: flags.server
	};
};
var _user$project$Main$receivedStringToMsg = function (s) {
	var _p1 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Protocol$jsonDecMessageForClient, s);
	if (_p1.ctor === 'Ok') {
		return _user$project$ClientState$MsgFromServer(_p1._0);
	} else {
		return _user$project$ClientState$None;
	}
};
var _user$project$Main$wsUrl = function (server) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'ws://',
		A2(_elm_lang$core$Basics_ops['++'], server, ':7999'));
};
var _user$project$Main$subscriptions = function (state) {
	return A2(
		_elm_lang$websocket$WebSocket$listen,
		_user$project$Main$wsUrl(state.server),
		_user$project$Main$receivedStringToMsg);
};
					...
					state,
					{
						...
						_0: function (_p3) {
							return A2(
								...
								_user$project$Main$wsUrl(state.server),
								A2(_elm_lang$core$Debug$log, 'send', _p3));
						}(
							A2(_user$project$Main$jsonActionOfNode, state, _p2._0)),
						_1: {ctor: '[]'}
					});
			case 'MsgFromServer':
				var _p4 = _p2._0;
				if (_p4.ctor === 'GameView_') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							state,
							{gameView: _p5.initialGameView, player: _p5.initialPlayer, network: _p5.networkForGame}),
						{ctor: '[]'});
				}
			case 'SelectEnergy':
				return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(state.player.playerId),
								')'))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A3(_user$project$View_MapView$mapView, state.network, _user$project$Main$displayInfo, state),
				_1: {
					ctor: '::',
					_0: A3(_user$project$View_TransportView$transportView, state.network, _user$project$Main$displayInfo, state),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$init = function (flags) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_user$project$Main$initialState(flags),
		{ctor: '[]'});
};
