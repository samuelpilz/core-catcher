...
exampleInvalidMove0 = playersState $ (\x -> exampleGameState { actions = x} )
...
exampleInvalidMove1 = playersState $ (\x -> exampleGameState { actions = x} )
...
exampleInvalidMove2 = playersState $ (\x -> exampleGameState { actions = x} )
...
exampleValidMove0 = playersState $ (\x -> exampleGameState { actions = x} )
